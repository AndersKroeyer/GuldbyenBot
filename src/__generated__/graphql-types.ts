...
export type ReportDataReportsArgs = {
  endTime: InputMaybe<Scalars['Float']>;
  gameZoneID?: InputMaybe<Scalars['Int']>;
  guildID?: InputMaybe<Scalars['Int']>;
  guildName: InputMaybe<Scalars['String']>;
...
export type ViewModelsSnippetsArgs = {
  snippetSlugs: InputMaybe<Array<InputMaybe<Scalars['String']>>>;
};
...
export type Unnamed_1_Query = { __typename?: 'Query', reportData: { __typename?: 'ReportData', report: { __typename?: 'Report', startTime: number, guild: { __typename?: 'Guild', name: string } | null } | null } | null };
